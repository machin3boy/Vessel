...
contract_address = "0x5C2B1279C9BD398297C2bD4B0273b93348a8d53F"
...
if __name__=="__main__":
    ...
    all_precisions = [10**18]*23 
    print("configuring precisions (all tokens)...")
    ...
    tx_list = [
        ["transfer", burn_address, 3*10**9*10**18],
        ["transfer", bounty_address, 100*10**6*10**18],
        ["transfer", vault_address, 3*10**9*10**18],
        ["vote", votes],
        ["setBalancedRatio", balanced_ratios],
        ["_setLastCoinPrices"],
        ["_setLastTokenPrice"],
        ["transfer", grady_address, 100*10**6*10**18],
        ["transfer", elmore_address, 100*10**6*10**18],
    ]
